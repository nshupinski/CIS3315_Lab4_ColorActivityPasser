...
//   ******************************
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(bundle != null) {
            String passedColor = bundle.getString("selectedColor");
            displayColor.setText("");
            displayColor.setText(passedColor);

            // get current layout
            FrameLayout layout = v.findViewById(R.id.canvas_layout);
            layout.setBackgroundColor(Color.parseColor(passedColor));
        }
